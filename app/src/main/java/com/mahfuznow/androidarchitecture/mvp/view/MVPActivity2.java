...
public class MVPActivity2 extends AppCompatActivity implements MVPPresenter.MyView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mvpactivity2);

        //set title and enabling back arrow button
        ActionBar actionBar = getSupportActionBar();
        if (actionBar != null) {
            actionBar.setTitle(R.string.mvp_activity_2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MVPActivity2.this, "You clicked on " + listValues.get(position), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onError() {
        progressBar.setVisibility(View.INVISIBLE);
        Toast.makeText(MVPActivity2.this,"Failed to load data",Toast.LENGTH_SHORT).show();
    }
}